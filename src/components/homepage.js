...
const HomePage = () => (
  <div>
    <Container text style={{ marginTop: "7em" }}>
      ...
      <p>
        STEP FIVE CHECK OUT YOUR EVENT and TELL OTHERS TO JOIN GROUPS and CHECK
        OUT THE EVENTS. YOU CAN COMMENT AND TALK TO EACH OTHER
      </p>
      ...
      <p>
        CHECK OUT NEW GROUPS AND JOIN GROUPS AND CHECK OUT THEIR EVENTS BY
        DIFFERENT USERS
      </p>
